# Running example file using 'en_core_web_sm'
...
# Observations
# The similarity scores considerably fall when the file is run using 'en_core_web_sm'.

# Explanation for this is also highlighted in the warning "UserWarning: [W007]
